# Contributing to <name-of-yout-project> [suggestion-not-validated]

## Welcome to the contribute guidelines

_NOTE: The following contributing.md was inspired in Atom's guideline._

The following is a set of guidelines for contributing to <name-of-your-project> and its packages, which are hosted in the [Vibrent](https://github.com/vribrenthealth) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
* Pull requests that adds new features must be highlited in way to be clear, _e.g_:
    * new feature include Go-lang code, so package must be: `[Go] feature-that-I-did`
* Pull requests that add one or more syntax highlighting grammars are named `language-[language-name]`
